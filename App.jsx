...
function App() {
    ...
    // शुरुआती नोड्स डेटा (पुराना वाला)
    ...
    // WebSocket लाइव अपडेट्स (पुराना वाला)
    useEffect(() => {
    ...
    return (
        <div style={{ padding: "20px", background: "#1a1f3c", minHeight: "100vh" }}>
            ...
            <div style={{ height: "500px", width: "100%", borderRadius: "8px", overflow: "hidden" }}>
                <MapContainer center={cityCenter} zoom={13} style={{ height: "100%", width: "100%" }}>
                    ...
                    {/* फिक्स किया हुआ रिलायबल ओपनस्ट्रीटमैप यूआरएल */}
                    <TileLayer
                        attribution='&copy; <a href="https://openstreetmap.org">OpenStreetMap</a> contributors'
                        url="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png"
                    />

                    {/* पुराने Marker को CircleMarker से बदल दिया गया है ताकि इमेज की ज़रूरत न पड़े */}
                    {nodes.map((node) => {
                        ...
                        return (
                            <CircleMarker 
                                ...
                                weight={2}                 // बॉर्डर मोटाई
                                fillOpacity={0.9}          // ओपेसिटी
                            >
                                <Popup>
